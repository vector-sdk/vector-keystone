...
QEMU_FLAGS := -m $(QEMU_MEM) -smp $(QEMU_SMP) -nographic \
                ...
                -append "console=ttyS0 ro rootwait root=/dev/vda" \
...
debug:
	$(call log,info,Debugging QEMU)
	$(BUILDROOT_BUILDDIR)/host/bin/qemu-system-riscv$(KEYSTONE_BITS) $(QEMU_FLAGS) $(QEMU_DEBUG)
...
ddd-connect:
	$(call log,info,Connecting ddd to QEMU)
	ddd --debugger '$(BUILDROOT_BUILDDIR)/host/bin/riscv$(KEYSTONE_BITS)-buildroot-linux-gnu-gdb \
                -iex "set KEYSTONE=$(KEYSTONE)" \
                -x $(KEYSTONE)/scripts/gdb/generic.cfg'
